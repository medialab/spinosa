...
import { llmClient } from "@spinosa/kernel-core/effect/app-node-platform"
...
import { LLMClient } from "@spinosa/llm/route"
import type { LLMClientService } from "@spinosa/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @spinosa/llm. It
