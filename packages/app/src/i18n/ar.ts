export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Spinosa",
  "desktop.recovery.terminated": "توقفت نافذة Spinosa بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Spinosa لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Spinosa",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa غير مثبت في {{distro}}",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Spinosa في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa غير مثبت",
  ...
  "wsl.onboarding.wslUnavailable.description": "تعذر على Spinosa التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Spinosa.",
  ...
  "help.tabs.introduction": "أصبح Spinosa الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Spinosa ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Spinosa",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Spinosa نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Spinosa داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Spinosa",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Spinosa على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Spinosa يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Spinosa.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Spinosa",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Spinosa.",
