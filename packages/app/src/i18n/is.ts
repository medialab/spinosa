...
export const dict = {
  ...
  "wsl.onboarding.opencodeReady": "Spinosa er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Spinosa í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa ekki uppsett",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa gat ekki staðfest WSL á þessari vél.",
  ...
  "help.tabs.introduction": "Spinosa er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Spinosa ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Spinosa teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Spinosa styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Spinosa inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Spinosa skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Spinosa netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Spinosa",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Spinosa lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Spinosa fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Spinosa er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Spinosa ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Spinosa.",
