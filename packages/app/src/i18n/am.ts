export const dict = {
  ...
  "desktop.recovery.loadFailed": "Spinosa መጫን አልቻለም",
  "desktop.recovery.terminated": "Spinosa መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Spinosa ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Spinosaመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa በ{{distro}}] ውስጥ አልተጫነም",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በSpinosa ይጠቀሙ።",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Spinosa በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosaአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Spinosa WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Spinosa በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Spinosa።",
  ...
  "help.tabs.introduction": "Spinosa ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የSpinosa ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለSpinosa ቡድን ያሳውቁ",
  ...
  "sidebar.gettingStarted.line1": "Spinosa ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Spinosa ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የSpinosa አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለSpinosa",
  ...
  "settings.general.row.appearance.description": "Spinosaበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Spinosa ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Spinosa ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Spinosa ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የSpinosa እትም እያሄዱ ነው።",
