...
import { normalizePromptContent } from "@spinosa/tui/editor"
...
import { SPINOSA_BASE_MODE, useBindings } from "@spinosa/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Spinosa" } satisfies SlashOption,
    ]
