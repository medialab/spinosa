import type { ExperimentalWorkspaceAdapterListResponse, Workspace } from "@spinosa/sdk/v2"
...
export function DialogWorkspaceSelect(props: {
  ...
  const omittedWorkspaceID = createMemo(() =>
    route.data.type === "workspace" && route.data.sessionID ? project.workspace.current() : undefined,
  )
