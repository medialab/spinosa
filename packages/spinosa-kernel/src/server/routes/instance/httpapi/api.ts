...
import { SpinosaWorkspaceGroup } from "./groups/spinosa-workspace"
...
export const RootHttpApi = HttpApi.make("spinosa-root")
...
export const InstanceHttpApi = HttpApi.make("spinosa-instance")
