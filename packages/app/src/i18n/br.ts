export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Spinosa",
  ...
  "desktop.menu.ariaLabel": "Menu do Spinosa",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Spinosa",
  "desktop.recovery.terminated": "A janela do Spinosa foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Spinosa não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Spinosa",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Spinosa não está instalado em {{distro}}",
  ...
  "wsl.onboarding.opencodeReady": "O Spinosa está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Spinosa em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa não instalado",
  ...
  "wsl.onboarding.wslUnavailable.description": "O Spinosa não conseguiu verificar o WSL neste computador.",
  ...
  "help.tabs.introduction": "Agora, o Spinosa é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Spinosa ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Spinosa",
  ...
  "sidebar.gettingStarted.line1": "Spinosa inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Spinosa dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Spinosa",
  ...
  "settings.general.row.appearance.description": "Personalize como o Spinosa aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Spinosa segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Spinosa é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Spinosa iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Spinosa.",
