...
import type { Agent, PermissionRequest, Project, Provider, ProviderListResponse } from "@spinosa/sdk/v2/client"
import type { Project as CurrentProject } from "@/utils/legacy-client"
