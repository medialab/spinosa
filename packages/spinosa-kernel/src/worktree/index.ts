...
import { path } from "@spinosa/kernel-core/effect/app-node-platform"
...
import type { ProjectV2 } from "@spinosa/kernel-core/project"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `spinosa/${name}`
