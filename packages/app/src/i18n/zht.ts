...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Spinosa 載入失敗",
  "desktop.recovery.terminated": "Spinosa 視窗意外終止",
  "desktop.recovery.unresponsive": "Spinosa 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Spinosa",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Spinosa 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Spinosa。",
  "wsl.onboarding.installOpencode": "安裝 Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Spinosa",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Spinosa。",
  ...
  "help.tabs.introduction": "Spinosa 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Spinosa 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Spinosa 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Spinosa 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Spinosa 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Spinosa 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Spinosa 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Spinosa 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Spinosa 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Spinosa 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Spinosa 啟動時自動檢查更新",
