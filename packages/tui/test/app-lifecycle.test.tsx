...
async function expectProcessSignalShutdown(signal: "SIGHUP" | "SIGINT") {
  ...
  try {
    ...
    expect(process.listeners(signal).every((listener) => listeners.has(listener))).toBe(true)
  } finally {
...
test("SIGHUP clears title and disposes scoped resources once", async () => {
  await expectProcessSignalShutdown("SIGHUP")
})

test("SIGINT clears title and disposes scoped resources once", async () => {
  await expectProcessSignalShutdown("SIGINT")
})
