...
//
// Enable with SPINOSA_DIRECT_TRACE=1. Writes one JSON line per event to
// ~/.spinosa/logs/direct/<timestamp>-<pid>.jsonl. Also writes
...
export function trace(): Trace | undefined {
  ...
  if (!process.env.SPINOSA_DIRECT_TRACE) {
    state = false
    return undefined
  }
