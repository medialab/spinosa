...
import { NonNegativeInt } from "@spinosa/kernel-core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/Auth") {}
  ...
  Effect.gen(function* () {
    ...
    const all = Effect.fn("Auth.all")(function* () {
      if (process.env.SPINOSA_AUTH_CONTENT) {
        try {
          return JSON.parse(process.env.SPINOSA_AUTH_CONTENT)
        } catch (err) {}
      }
