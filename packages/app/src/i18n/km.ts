export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ Spinosa",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ Spinosa",
  ...
  "desktop.recovery.loadFailed": "Spinosa បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច Spinosa ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "Spinosa មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installOpencode": "ការដំឡើង Spinosa បានបរាជ័យ",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa គឺរួចរាល់។",
  "wsl.onboarding.installOpencodeIn": "ដំឡើង Spinosa ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpencode": "ដំឡើង Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  ...
  "help.tabs.introduction": "Spinosa ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.update.description": "កំណែថ្មីនៃ Spinosa ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម Spinosa",
  ...
  "sidebar.gettingStarted.line1": "Spinosa រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ Spinosa នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ Spinosa",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល Spinosa មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ Spinosa ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល Spinosa មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល Spinosa ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ Spinosa ។",
