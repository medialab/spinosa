...
beforeAll(async () => {
  ...
  mock.module("@spinosa/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@spinosa/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@spinosa/ui/icon", () => ({ Icon: () => null }))
  mock.module("@spinosa/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
