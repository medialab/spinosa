...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Spinosa 加载失败",
  "desktop.recovery.terminated": "Spinosa 窗口意外终止",
  "desktop.recovery.unresponsive": "Spinosa 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Spinosa",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Spinosa 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Spinosa 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Spinosa。",
  "wsl.onboarding.installOpencode": "安装 Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Spinosa",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Spinosa 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Spinosa 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Spinosa。",
  ...
  "help.tabs.introduction": "Spinosa 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Spinosa 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Spinosa 团队",
  ...
  "sidebar.gettingStarted.line1": "Spinosa 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Spinosa 服务器。",
  ...
  "settings.general.row.language.description": "更改 Spinosa 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Spinosa 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Spinosa 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Spinosa 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Spinosa 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Spinosa。",
