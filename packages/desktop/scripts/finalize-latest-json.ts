...
const releaseId = process.env.SPINOSA_RELEASE
if (!releaseId) throw new Error("SPINOSA_RELEASE is required")

const version = process.env.SPINOSA_VERSION
if (!version) throw new Error("SPINOSA_VERSION is required")
...
const macxTarGz = "spinosa-desktop-mac-x64.app.tar.gz"
const macaTarGz = "spinosa-desktop-mac-arm64.app.tar.gz"
