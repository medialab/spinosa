...
import { MAX_STEPS_PROMPT } from "@spinosa/kernel-core/session/runner/max-steps"
...
import { LLM } from "./llm"
import { Shell } from "@spinosa/kernel-core/shell"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/SessionPrompt") {}
