...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://medialab.github.io/spinosa/" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/medialab/spinosa/discussions" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/medialab/spinosa/issues/new",
      },
      {
        type: "item",
