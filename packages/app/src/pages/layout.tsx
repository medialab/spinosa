...
import { Session } from "@spinosa/sdk/v2/client"
...
import { useTheme, type ColorScheme } from "@spinosa/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://github.com/medialab/spinosa/issues/new")}
      renderPanel={() =>
