...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Spinosa failed to load",
  "desktop.recovery.terminated": "Spinosa window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Spinosa is not responding",
