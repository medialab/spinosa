export const dict = {
  ...
  "toast.update.description": "Spinosa의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Spinosa 팀에 제보해 주세요: ",
  ...
  "sidebar.gettingStarted.line1": "Spinosa에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Spinosa 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Spinosa 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Spinosa가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Spinosa가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Spinosa 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Spinosa를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Spinosa를 사용 중입니다.",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Spinosa를 설치하세요.",
  "wsl.onboarding.installOpencode": "Spinosa 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa가 설치되지 않음",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Spinosa를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 Spinosa은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "Spinosa를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Spinosa 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Spinosa가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Spinosa가 설치되어 있지 않습니다",
