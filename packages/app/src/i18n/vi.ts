export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Spinosa",
  ...
  "desktop.recovery.loadFailed": "Không tải được Spinosa",
  "desktop.recovery.terminated": "Cửa sổ Spinosa đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Spinosa không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Spinosa",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa chưa được cài đặt trong {{distro}}",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Spinosa trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa chưa được cài đặt",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Spinosa.",
  ...
  "help.tabs.introduction": "Spinosa nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Spinosa ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Spinosa",
  ...
  "sidebar.gettingStarted.line1": "Spinosa bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Spinosa bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Spinosa",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Spinosa trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Spinosa tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Spinosa.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Spinosa khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Spinosa.",
