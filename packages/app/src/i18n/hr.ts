...
export const dict = {
  ...
  "wsl.onboarding.installOpencodeIn": "Instalirajte Spinosa u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Spinosa",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa nije mogao potvrditi WSL na ovom stroju.",
  ...
  "help.tabs.introduction": "Radna površina Spinosa sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Spinosa ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Spinosa timu",
  ...
  "sidebar.gettingStarted.line1": "Spinosa uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Spinosa Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Spinosa poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Spinosa",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Spinosa izgleda na vašem uređaju",
  ...
  "settings.general.row.theme.description": "Prilagodite način na koji je Spinosa tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Spinosa pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Spinosa.",
