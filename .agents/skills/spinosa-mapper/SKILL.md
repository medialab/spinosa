...
name: spinosa-mapper
description: |
  Reads raw files in batch and extracts content-grounded fragments. Writes
  extraction packets and navigation maps.
  Use when raw files need batch processing for extraction of content-grounded
  retrieval fragments.
---
