export const dict = {
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa er ikke installeret",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa kunne ikke bekræfte WSL på denne maskine.",
  ...
  "toast.update.description": "En ny version af Spinosa ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Spinosa-teamet",
  ...
  "sidebar.gettingStarted.line1": "Spinosa inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Spinosa-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Spinosa",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Spinosa ser ud på din enhed",
  ...
  "settings.general.row.theme.description": "Tilpas Spinosas tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Spinosa starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Spinosa.",
  ...
  "desktop.recovery.loadFailed": "Spinosa kunne ikke indlæses",
  "desktop.recovery.terminated": "Spinosa-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Spinosa mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa er ikke installeret i {{distro}}",
  ...
  "help.tabs.introduction": "Spinosa er nu bygget op omkring faner.",
  "help.tabs.sessions":
