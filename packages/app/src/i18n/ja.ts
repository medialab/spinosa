export const dict = {
  ...
  "desktop.recovery.loadFailed": "Spinosaを読み込めませんでした",
  "desktop.recovery.terminated": "Spinosaのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Spinosaが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Spinosaのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはSpinosaがインストールされていません",
  ...
  "wsl.onboarding.opencodeReady": "Spinosaの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にSpinosaをインストールしてください。",
  "wsl.onboarding.installOpencode": "Spinosaをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosaがインストールされていません",
  ...
  "help.tabs.introduction": "Spinosaでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Spinosaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをSpinosaチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "Spinosaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でSpinosaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Spinosaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのSpinosaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Spinosaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Spinosaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Spinosa の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Spinosa は最新バージョンです。",
