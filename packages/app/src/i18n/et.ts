export const dict = {
  ...
  "desktop.recovery.loadFailed": "Spinosa laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Spinosa aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Spinosa ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa pole installitud asukohta {{distro}}",
  ...
  "wsl.onboarding.installOpencodeIn": "Installige Spinosa asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa pole installitud",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Spinosa.",
  ...
  "help.tabs.introduction": "Spinosa Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Spinosa ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Spinosa meeskonnale",
  ...
  "sidebar.gettingStarted.line1": "Spinosa sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Spinosa Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Spinosa server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Spinosa kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Spinosa teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Spinosa järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Spinosa on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Spinosa käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Spinosa uusimat versiooni.",
