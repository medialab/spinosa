...
import type { FileDiffInfo } from "./session-diff"
import { useData } from "../context"
import { useFileComponent } from "@spinosa/ui/context/file"

import { Binary } from "@spinosa/kernel-core/util/binary"
                ...
                >
                  <div data-slot="session-turn-diffs-header">
                    ...
                    <Show when={overflow() > 0}>
                      <button type="button" data-slot="session-turn-diffs-toggle" aria-expanded={showAll()} onClick={toggleAll}>
