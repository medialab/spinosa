...
export { Effect, Rule, Ruleset } from "@spinosa/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/v2/Permission") {}
...
const layer = Layer.effect(
  ...
  EffectRuntime.gen(function* () {
    ...
    const configured = EffectRuntime.fn("PermissionV2.configured")(function* (
      ...
      const sessionRules = (session as SessionV2.Info & { permission?: Permission.Ruleset }).permission ?? []
      return merge(agentRules, sessionRules)
    })
