...
export const dict = {
  ...
  "wsl.onboarding.opencodeReady": "A Spinosa készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a Spinosa-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a Spinosa-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A Spinosa nincs telepítve",
  ...
  "wsl.onboarding.wslUnavailable.description": "A Spinosa nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  ...
  "help.tabs.introduction": "A Spinosa mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Spinosa ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Spinosa csapatának",
  ...
  "sidebar.gettingStarted.line1": "A Spinosa ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Spinosa asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Spinosa szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Spinosa kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Spinosa az eszközén",
  ...
  "settings.general.row.theme.description": "Szabja személyre a Spinosa témáját.",
  ...
  "settings.updates.row.startup.description": "A Spinosa indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Spinosa legújabb verzióját futtatja.",
