...
import { Switch } from "@spinosa/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://medialab.github.io/spinosa/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_SPINOSA_CHANNEL !== "prod"}>
          <SettingsRowV2
