...
import { PermissionSaved } from "@spinosa/kernel-core/permission/saved"
import { ProjectV2 } from "@spinosa/kernel-core/project"
import { ProjectCopy } from "@spinosa/kernel-core/project/copy"
import { PtyTicket } from "@spinosa/kernel-core/pty/ticket"
...
import { handlers } from "@spinosa/server/handlers"
import { buildLocationServiceMap, LocationServiceMap } from "@spinosa/kernel-core/location-services"
import { layer as locationLayer } from "@spinosa/server/location"
import { sessionLocationLayer } from "@spinosa/server/middleware/session-location"
...
import { memoMap } from "@spinosa/kernel-core/effect/memo-map"
...
const serverHttpApiAuthLayer = serverAuthorizationLayer.pipe(Layer.provide(SharedServerAuth.Config.layer))
