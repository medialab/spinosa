...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@spinosa/llm"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/v2/ToolRegistry") {}
