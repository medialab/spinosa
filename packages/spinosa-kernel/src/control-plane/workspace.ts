...
import { EventSequenceTable, EventTable } from "@spinosa/kernel-core/event/sql"
...
import { WorkspaceTable } from "@spinosa/kernel-core/control-plane/workspace.sql"
...
import { WorkspaceEvent } from "@spinosa/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@spinosa/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SPINOSA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SPINOSA_WORKSPACE_ID: config.id,
        SPINOSA_EXPERIMENTAL_WORKSPACES: "true",
