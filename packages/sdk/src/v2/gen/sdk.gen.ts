...
import type {
  ...
  GlobalSpinosaWorkspacesListErrors,
  GlobalSpinosaWorkspacesListResponses,
  GlobalSpinosaWorkspacesRecoverErrors,
  GlobalSpinosaWorkspacesRecoverResponses,
  GlobalSpinosaWorkspacesRecoverScanErrors,
  GlobalSpinosaWorkspacesRecoverScanResponses,
  GlobalSpinosaWorkspacesUnregisterErrors,
  GlobalSpinosaWorkspacesUnregisterResponses,
  GlobalUpgradeErrors,
  ...
  OnboardingJobCancelResponses,
  OnboardingJobGetErrors,
  OnboardingJobGetResponses,
  OnboardingPreviewErrors,
  OnboardingPreviewResponses,
  OnboardingScanCancelErrors,
  OnboardingScanCancelResponses,
  OnboardingScanGetErrors,
  OnboardingScanGetResponses,
  OnboardingStartErrors,
  OnboardingStartResponses,
  OnboardingToolsGetErrors,
  OnboardingToolsGetResponses,
  OnboardingToolsRepairErrors,
  OnboardingToolsRepairResponses,
  OutputFormat,
  Part as Part2,
  PartDeleteErrors,
  PartDeleteResponses,
  ...
  ProviderVisionTranscribeErrors,
  ProviderVisionTranscribeResponses,
  PtyConnectErrors,
  PtyConnectResponses,
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Spinosa system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Spinosa system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Spinosa server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Spinosa state.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Spinosa sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Spinosa configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    options?: Options<never, ThrowOnError>,
  ): RequestResult<
  ...
  > {
    return (options?.client ?? this.client).get<
      ...
      GlobalConfigGetErrors,
      ThrowOnError
    >({ url: "/global/config", ...options })
  }

  /**
   * Update global configuration
   *
   * Update global Spinosa configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      config?: Config3
...
export class Recover extends HeyApiClient {
  /**
   * Find a missing workspace by identity
   *
   * Search local recovery roots for a matching Spinosa workspace marker and recover a unique match.
   */
...
export class Workspaces extends HeyApiClient {
  /**
   * List registered Spinosa workspaces
   *
   * List registry-backed workspaces, including missing and incomplete entries.
   */
  public list<ThrowOnError extends boolean = false>(
    options?: Options<never, ThrowOnError>,
  ): RequestResult<
  ...
  > {
    return (options?.client ?? this.client).get<
      ...
      GlobalSpinosaWorkspacesListErrors,
      ThrowOnError
    >({ url: "/global/spinosa/workspaces", ...options })
  }

  /**
   * Recover a registered workspace at a new path
   *
   * Validate a Spinosa marker and update the local workspace registry without moving files.
   */
   ...
   *
   * Unregister a workspace without deleting its files.
   */
  ...
  private _recover?: Recover
  get recover2(): Recover {
    return (this._recover ??= new Recover({ client: this.client }))
  }
}
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Spinosa server.
   */
  public health<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<
      ...
      GlobalHealthErrors,
      ThrowOnError
    >({ url: "/global/health", ...options })
  }

  /**
   * Get global events
   *
   * Subscribe to global events from the Spinosa system using server-sent events.
   */
  public event<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).sse.get<
      ...
      GlobalEventErrors,
      ThrowOnError
    >({ url: "/global/event", ...options })
  }

  /**
   * Dispose instance
   *
   * Clean up and dispose all Spinosa instances, releasing all resources.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Spinosa configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Spinosa configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Spinosa instance, releasing all resources.
   */
  public dispose<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Vcs extends HeyApiClient {
   ...
   * Get VCS diff
   *
   * Retrieve the current git diff for the working tree or against the default branch. Unavailable comparisons include a reason.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Spinosa system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Spinosa.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Spinosa is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Spinosa.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Spinosa sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Spinosa session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Spinosa session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Tools extends HeyApiClient {
  /**
   * Check document-processing tools
   *
   * Check which bundled document-processing tools are available before scanning sources.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
  ...
  /**
   * Repair missing document-processing tools
   *
   * Run the bundled framework installer in reinstall mode, then re-check tool availability.
   */
...
export class Scan extends HeyApiClient {
  /**
   * Read source scan progress
   *
   * Get the active source folder, file, and count while onboarding scans source folders.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      scanID: string
  ...
  /**
   * Cancel a source scan
   *
   * Stop the active source scan before the workspace import begins.
   */
...
export class Active extends HeyApiClient {
  /**
   * Find an active onboarding job
   *
   * Reconnect to an active onboarding import for a source folder.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Job extends HeyApiClient {
   ...
   *
   * Get current setup phase, file progress, gate, and final result.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      jobID: string
  ...
  /**
   * Continue or resolve an onboarding phase
   *
   * Continue a phase gate or choose how to resolve a vision transcription failure.
   */
  ...
  /**
   * Cancel workspace onboarding
   *
   * Abort active conversion work and leave the workspace registered for resume.
   */
  public cancel<ThrowOnError extends boolean = false>(
    parameters: {
      jobID: string
...
export class Onboarding extends HeyApiClient {
  /**
   * Scan source folders for onboarding
   *
   * Classify importable files, file extensions, and available document-processing tools.
   */
  ...
  /**
   * Create and import a Spinosa workspace
   *
   * Run the shared core onboarding workflow as a cancellable background job.
   */
  public start<ThrowOnError extends boolean = false>(
    parameters: {
      directory?: string
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "resumeWorkspacePath" },
            { in: "body", key: "extensions" },
            { in: "body", key: "visionModelId" },
            { in: "body", key: "preferredCli" },
          ],
        },
      ],
    )
  ...
  private _scan?: Scan
  get scan(): Scan {
    return (this._scan ??= new Scan({ client: this.client }))
  }
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Retrieve foreground Session drains currently owned by this Spinosa process. Sessions absent from the result are inactive.
   */
  ...
  > {
    return (options?.client ?? this.client).get<
      ...
      V2SessionActiveErrors,
      ThrowOnError
    >({ url: "/api/session/active", ...options })
  }
   ...
   *
   * Interrupt active execution owned by this Spinosa process. Idle interruption is a no-op.
   */
...
export class OpencodeClient extends HeyApiClient {
  public static readonly __registry: HeyApiRegistry<OpencodeClient> =
    new HeyApiRegistry<OpencodeClient>()
