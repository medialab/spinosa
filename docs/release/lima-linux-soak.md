...
- **Cross-arch Lima** (`--arch x86_64` on arm64 Mac): qemu, slower, more RAM; prefer native aarch64 for day-to-day Linux soak; still run x64 before stable. Installer staged-binary verify defaults to **180s** for canvas/native cold-boot cost on qemu.
