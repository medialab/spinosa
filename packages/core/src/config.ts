...
export class Service extends Context.Service<Service, Interface>()("@spinosa/v2/Config") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    // global config, project files, then `.spinosa` files.
