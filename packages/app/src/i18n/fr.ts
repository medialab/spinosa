export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Spinosa",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Spinosa",
  "desktop.recovery.terminated": "La fenêtre Spinosa s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Spinosa ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Spinosa",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa n'est pas installé dans {{distro}}",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Spinosa dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa non installé",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa n'a pas pu vérifier WSL sur cet appareil.",
  ...
  "help.tabs.introduction": "Spinosa s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Spinosa ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Spinosa",
  ...
  "sidebar.gettingStarted.line1": "Spinosa includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Spinosa dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Spinosa",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Spinosa sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Spinosa suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Spinosa.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Spinosa",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Spinosa.",
