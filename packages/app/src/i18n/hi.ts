export const dict = {
  ...
  "desktop.menu.documentation": "Spinosa दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Spinosa मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Spinosa लोड नहीं हो सका",
  "desktop.recovery.terminated": "Spinosa विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Spinosa प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Spinosa इंस्टॉल नहीं है",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Spinosa स्थापित करें।",
  "wsl.onboarding.installOpencode": "Spinosa स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa स्थापित नहीं है",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  ...
  "help.tabs.introduction": "Spinosa अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Spinosa ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Spinosa टीम को करें",
  ...
  "sidebar.gettingStarted.line1": "Spinosa में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Spinosa सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Spinosa के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Spinosa आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Spinosa सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Spinosa की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Spinosa लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Spinosa का नवीनतम संस्करण चला रहे हैं।",
