...
export const dict = {
  ...
  "prompt.suggestions.commands": "Commands",
  "prompt.suggestions.commandTag": "COMMAND",
  "prompt.suggestions.skillTag": "SKILL",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Spinosa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Spinosa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Spinosa.",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Spinosa in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Spinosa can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Spinosa could not verify WSL on this machine.",
  ...
  "help.tabs.introduction": "Spinosa is now built around tabs.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Please report this error to the Spinosa team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Spinosa does not support MCP authentication yet.',
  ...
  "home.title": "Home",
  "home.leaveTask.title": "Stop current task?",
  "home.leaveTask.message": "Going home will stop the current task",
  "session.leaveTask.message": "Leaving this conversation will stop the current task",
  "home.leaveTask.stopping": "Stopping current task…",
  "home.leaveTask.yes": "YES",
  "home.leaveTask.no": "NO",
  ...
  "spinosaHome.registeredWorkspaces": "Registered workspaces",
  ...
  "session.route.general": "General prompt",
  "session.route.chat": "Chat",
  ...
  "session.visualizer.refresh": "Refresh",
  "session.visualizer.unlinkedFolders": "No links found · grouped by folder",
  "session.visualizer.unlinked": "No links found in raw/ · showing files without connections",
  "session.visualizer.noMatches": "No files match these graph filters.",
  "session.visualizer.settings": "Graph settings",
  "session.visualizer.search": "Search files",
  "session.visualizer.filters": "Filters",
  "session.visualizer.attachments": "Attachments",
  "session.visualizer.orphans": "Orphans",
  "session.visualizer.local": "Local graph",
  "session.visualizer.openLocal": "Open local graph",
  "session.visualizer.openFile": "Open file",
  "session.visualizer.metadataBond": "Shared metadata",
  "session.visualizer.fileLink": "File link",
  "session.visualizer.global": "Global graph",
  "session.visualizer.depth": "Depth",
  "session.visualizer.display": "Display",
  "session.visualizer.arrows": "Arrows",
  "session.visualizer.textFade": "Text fade threshold",
  "session.visualizer.nodeSize": "Node size",
  "session.visualizer.linkThickness": "Link thickness",
  "session.visualizer.forces": "Forces",
  "session.visualizer.centerForce": "Center force",
  "session.visualizer.repelForce": "Repel force",
  "session.visualizer.linkForce": "Link force",
  "session.visualizer.linkDistance": "Link distance",
  "session.visualizer.linkedCluster": "Linked files",
  ...
  "session.followupDock.upNext": "Up next",
  "session.followupDock.remove": "Remove from queue",
  "session.followupDock.steerFailed": "Couldn’t steer queued message",
  ...
  "session.new.workspace.loading": "Loading…",
  ...
  "session.header.backToHome": "Back to workspace home",
  ...
  "dialog.spinosaOnboarding.title": "Create Spinosa workspace",
  "dialog.spinosaOnboarding.sourcesDescription": "Choose one or more folders to import into a new workspace.",
  "dialog.spinosaOnboarding.pickSources": "Choose folders",
  "dialog.spinosaOnboarding.manualPath": "Folder path",
  "dialog.spinosaOnboarding.manualPathPlaceholder": "/path/to/documents",
  "dialog.spinosaOnboarding.addPath": "Add path",
  "dialog.spinosaOnboarding.nameDescription": "Give this workspace a name before Spinosa scans the selected folders.",
  "dialog.spinosaOnboarding.nameLabel": "Workspace name",
  "dialog.spinosaOnboarding.back": "Back",
  "dialog.spinosaOnboarding.toolsDescription": "Check the bundled document tools Spinosa can use during import.",
  "dialog.spinosaOnboarding.checkingTools": "Checking bundled document-processing tools…",
  "dialog.spinosaOnboarding.repairingTools": "Repairing missing document-processing tools…",
  "dialog.spinosaOnboarding.toolRepairLog": "Tool repair log",
  "dialog.spinosaOnboarding.repairTools": "Repair missing tools",
  "dialog.spinosaOnboarding.repairFailed": "Tool repair did not complete successfully.",
  "dialog.spinosaOnboarding.available": "Available",
  "dialog.spinosaOnboarding.missing": "Missing",
  "dialog.spinosaOnboarding.scanDescription": "Review the scanned source folders before choosing file types.",
  "dialog.spinosaOnboarding.scanning": "Scanning source folders…",
  "dialog.spinosaOnboarding.cancelScan": "Cancel scan",
  "dialog.spinosaOnboarding.scanProgress": "Scanning source {{source}} of {{sources}} · {{current}} of {{total}} files",
  "dialog.spinosaOnboarding.scanEmpty": "No files were found. Go back and choose another source folder.",
  "dialog.spinosaOnboarding.scanFiles": "{{count}} files found",
  "dialog.spinosaOnboarding.extensionsDescription": "Choose the file types to import.",
  "dialog.spinosaOnboarding.selectAll": "Select all",
  "dialog.spinosaOnboarding.deselectAll": "Deselect all",
  "dialog.spinosaOnboarding.visionDescription": "Choose a vision model for scans and images, or keep those files unchanged.",
  "dialog.spinosaOnboarding.copyAsIs": "Copy scans and images as-is",
  "dialog.spinosaOnboarding.noVisionModels": "No connected vision models are available. You can still copy files as-is.",
  "dialog.spinosaOnboarding.start": "Create workspace and import",
  "dialog.spinosaOnboarding.cancelImport": "Cancel import",
  "dialog.spinosaOnboarding.continueInBackground": "Continue in background",
  "dialog.spinosaOnboarding.cancelConfirm": "Stop this import? The workspace and completed files will remain available to resume.",
  "dialog.spinosaOnboarding.keepImporting": "Keep importing",
  "dialog.spinosaOnboarding.importPhase": "Import {{phase}}",
  "dialog.spinosaOnboarding.retry": "Retry",
  "dialog.spinosaOnboarding.skip": "Skip file",
  "dialog.spinosaOnboarding.verification": "Imported {{imported}}, recovered {{recovered}}, failed {{failed}}, still missing {{missing}}.",
  "dialog.spinosaOnboarding.openWorkspace": "Open workspace",
  "dialog.spinosaOnboarding.openAndStart": "Open and start setup",
  "dialog.spinosaOnboarding.launchDescription": "Choose how to continue. Spinosa Desktop can open the workspace with /startup ready, or open it without starting the setup brief.",
  "dialog.spinosaOnboarding.logs": "Import logs",
  "dialog.spinosaOnboarding.files": "Processed files ({{count}})",
  "dialog.workspace.recovery.title": "Recover workspace",
  "dialog.workspace.recovery.description": "Find “{{name}}” again or remove its registry entry. Workspace files are never deleted here.",
  "dialog.workspace.recovery.manual": "Recover from a folder",
  "dialog.workspace.recovery.pathPlaceholder": "/path/to/workspace",
  "dialog.workspace.recovery.chooseFolder": "Choose folder",
  "dialog.workspace.recovery.recover": "Recover",
  "dialog.workspace.recovery.searchTitle": "Search by workspace identity",
  "dialog.workspace.recovery.searchDescription": "Search common local folders for this workspace marker. File contents are not read or uploaded.",
  "dialog.workspace.recovery.search": "Search folders",
  "dialog.workspace.recovery.searching": "Searching local folders…",
  "dialog.workspace.recovery.failed": "Workspace recovery search failed.",
  "dialog.workspace.recovery.multiple": "More than one match was found. Choose the correct workspace folder.",
  "dialog.workspace.recovery.notFound": "No matching workspace was found. Choose its folder manually.",
  "dialog.workspace.recovery.remove": "Remove from list",
  "dialog.workspace.recovery.removeConfirm": "This only removes the registry entry. Files on disk will remain untouched.",
  "dialog.workspace.recovery.missing": "Workspace folder is missing",
  "dialog.workspace.recovery.incomplete": "Workspace setup is incomplete",
  "dialog.workspace.recovery.resume": "Resume setup",
  "dialog.workspace.recovery.startup": "Continue setup",
  "common.edit": "Edit",
  ...
  "settings.desktop.wsl.description": "Run the Spinosa server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Spinosa",
  ...
  "settings.general.row.theme.description": "Customise how Spinosa is themed.",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Spinosa.",
