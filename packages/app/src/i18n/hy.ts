export const dict = {
  ...
  "desktop.menu.documentation": "Spinosa Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Spinosa մենյու",
  ...
  "desktop.recovery.loadFailed": "Spinosa չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Spinosa պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Spinosa-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa տեղադրված չէ {{distro}}",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Spinosa-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Spinosa",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa տեղադրված չէ",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  ...
  "help.tabs.introduction": "Spinosa-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Spinosa-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Spinosa թիմին",
  ...
  "sidebar.gettingStarted.line1": "Spinosa ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Spinosa սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Spinosa",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Spinosa տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Spinosa-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Spinosa-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Spinosa-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Spinosa-ի վերջին տարբերակը։",
