export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Spinosa ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Spinosa মেনু",
  ...
  "desktop.recovery.loadFailed": "Spinosa লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Spinosa উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Spinosa সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "Spinosa ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Spinosa {{distro}} এ ইনস্টল করা নেই",
  ...
  "wsl.onboarding.opencodeReady": "Spinosa প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Spinosa ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "Spinosa ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Spinosa ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslUnavailable.description": "Spinosa এই মেশিনে WSL যাচাই করতে পারেনি।",
  ...
  "help.tabs.introduction": "Spinosa ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Spinosa ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Spinosa টিমের কাছে রিপোর্ট করুন",
  ...
  "sidebar.gettingStarted.line1": "Spinosa বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "Spinosa ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Spinosa সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Spinosa-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Spinosa কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Spinosa সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Spinosa থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Spinosa চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি Spinosa এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
